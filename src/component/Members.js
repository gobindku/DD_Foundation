...
<div className="card-grid">
  ...
  <div className="card" style={{ width: "18rem", margin: "auto" }}>
    ...
    <div className="card-body">
      ...
      <p className="card-text">Educator & SOW</p>
    </div>
  </div>
  ...
  <div className="card" style={{ width: "18rem", margin: "auto" }}>
    ...
    <div className="card-body">
      ...
      <p className="card-text">Educator & MOD</p>
    </div>
  </div>
  <div className="card" style={{ width: "18rem", margin: "auto" }}>
    ...
    <div className="card-body">
      ...
      <p className="card-text">Educator & MSI</p>
    </div>
  </div>
  ...
  <div className="card" style={{ width: "18rem", margin: "auto" }}>
    ...
    <div className="card-body">
      ...
      <p className="card-text">Educator & OOD</p>
    </div>
  </div>
  ...
  <div className="card" style={{ width: "18rem", margin: "auto" }}>
    ...
    <div className="card-body">
      ...
      <p className="card-text">Tech Ass</p>
    </div>
  </div>
